<?php
    ...
    if (!empty($_POST['sadminID']) && !empty($_POST['sadminPASSWORD']) && empty($_POST['sadminOTP'])) {
    ...
    if(!empty($_POST['sadminOTP']) && !empty($_POST['sadminEMAIL']) && !empty($_POST['sadminDBID'])){
...
<body id="all" onload="pageRedirect()">
    ...
    <div class="container mb-3 mt-5 user-select-none text-center" style="color: white;">
        ...
        <?php
            if($status!= 1){
                echo '<h5 class="text-dark my-3">This Page Will Be Close In: <span id="countdown">180</span> seconds.</h5>';
            }
            if($status== 1){
                echo '<h5 class="text-dark my-3">The OTP Will Be Valid For Next: <span id="countdown">180</span> seconds.</h5>';
            }
        ?>
    </div>
    <!-- Page Title END -->
    ...
    <div class="container text-dark col-md-6">
        ...
        ?>
        <form action="_superadminlogin.php" method="POST" autocomplete="off">
            <?php
                if($status!= 1){
                    echo '<div class="mb-3">
    ...
    <script>
        function pageRedirect(){
            setTimeout(function(){location.href="_adminpanel.php?panel=admin"} , 180000);
        }
